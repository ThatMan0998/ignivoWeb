...
export default function ProductPreview() {
  return (
    <figure className="relative mx-auto w-full max-w-3xl text-left">
      <div aria-hidden="true" className="absolute -inset-4 rounded-full bg-primary-light/15 blur-3xl" />
      <div className="relative overflow-hidden rounded-3xl border border-border bg-white/90 p-5 shadow-2xl shadow-primary/10 backdrop-blur-sm sm:p-8">
        <div className="flex flex-wrap items-center justify-between gap-3 border-b border-border pb-5">
          <span className="font-bold text-primary">IGNIVO / Hệ sinh thái kết nối</span>
        ...
        <div className="rounded-2xl bg-gradient-to-r from-primary-dark to-primary p-5 text-center text-white">
        ...
        <ArrowDown aria-hidden="true" className="mx-auto my-4 text-primary" />
        <div className="grid grid-cols-2 gap-3 text-sm font-semibold text-primary sm:gap-6">
          <div className="flex items-center gap-3 rounded-2xl bg-background-secondary p-4"><BellRing aria-hidden="true" className="shrink-0" />Còi tại chỗ</div>
          <div className="flex items-center gap-3 rounded-2xl bg-background-secondary p-4"><Smartphone aria-hidden="true" className="shrink-0" />Ứng dụng</div>
        </div>
      </div>
