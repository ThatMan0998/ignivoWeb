...
import { Activity, BellRing, Camera, RotateCcw, Move3d } from 'lucide-react';
...
const DEVICES = [
  ...
  { id: 'alarm', Icon: BellRing, label: 'Bộ cảnh báo', detail: 'Kích hoạt cảnh báo khi hệ thống xác nhận rủi ro.' },
];
const STATUS = [
  ...
  '03 · Kích hoạt còi và minh họa thông báo đến người quản lý.',
];
...
export default function IgnivoRoomDemo() {
  ...
  useEffect(() => {
    if (phase === 0 || phase === 3 || loadState !== 'ready') return;
